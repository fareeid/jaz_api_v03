...
Revision ID: 53f90d9a3631
Revises: 
Create Date: 2024-07-19 12:32:25.474487
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_payload_MCINotification'), 'payload', ['MCINotification'], unique=False)
    op.create_index(op.f('ix_payload_pl_sys_id'), 'payload', ['pl_sys_id'], unique=False)
    ...
    sa.Column('quot_paymt_date', sa.TIMESTAMP(timezone=True), nullable=True),
    sa.Column('quot_payload', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('created_by', sa.Integer(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('updated_by', sa.Integer(), nullable=True),
    ...
    op.create_index(op.f('ix_quote_quot_sys_id'), 'quote', ['quot_sys_id'], unique=False)
    ...
    sa.Column('lic_no', sa.String(), nullable=True),
    sa.Column('gender', sa.String(), nullable=True),
    sa.Column('dob', sa.DateTime(), nullable=True),
    sa.Column('cust_code', sa.String(length=10), nullable=True),
    sa.Column('cust_cc_code', sa.String(), nullable=True),
    sa.Column('cust_customer_type', sa.String(), nullable=True),
    sa.Column('user_flexi', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.Column('premia_cust_payload', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    ...
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('updated_by', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['owner_id'], ['person.id'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('updated_by', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['prop_quot_sys_id'], ['quote.quot_sys_id'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('prop_sys_id')
    )
    op.create_index(op.f('ix_proposal_prop_sys_id'), 'proposal', ['prop_sys_id'], unique=False)
    op.create_table('proposalcharge',
    ...
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('updated_by', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['chg_prop_sys_id'], ['proposal.prop_sys_id'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('chg_sys_id')
    )
    op.create_index(op.f('ix_proposalcharge_chg_sys_id'), 'proposalcharge', ['chg_sys_id'], unique=False)
    op.create_table('proposalsection',
    ...
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('updated_by', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['sec_prop_sys_id'], ['proposal.prop_sys_id'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('sec_sys_id')
    )
    op.create_index(op.f('ix_proposalsection_sec_sys_id'), 'proposalsection', ['sec_sys_id'], unique=False)
    op.create_table('proposalrisk',
    ...
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('updated_by', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['risk_sec_sys_id'], ['proposalsection.sec_sys_id'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('risk_sys_id')
    )
    op.create_index(op.f('ix_proposalrisk_risk_sys_id'), 'proposalrisk', ['risk_sys_id'], unique=False)
    op.create_table('proposalcover',
    ...
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('updated_by', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['cvr_risk_sys_id'], ['proposalrisk.risk_sys_id'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('cvr_sys_id')
    )
    op.create_index(op.f('ix_proposalcover_cvr_sys_id'), 'proposalcover', ['cvr_sys_id'], unique=False)
    op.create_table('proposalsmi',
    ...
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('updated_by', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['smi_risk_sys_id'], ['proposalrisk.risk_sys_id'], onupdate='CASCADE', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('smi_sys_id')
    )
    op.create_index(op.f('ix_proposalsmi_smi_sys_id'), 'proposalsmi', ['smi_sys_id'], unique=False)
